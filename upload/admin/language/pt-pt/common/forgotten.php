...
$_['text_email']      = 'Após fornecer seu e-mail já está registado no nosso sistema, clique no botão Redefinir para receber no e-mail fornecido um link para que você possa redefinir sua senha.';
$_['text_success']    = 'O e-mail com um link para redefinir sua senha foi enviado para seu endereço de e-mail.';

// Entry
$_['entry_email']     = 'E-mail registado na loja:';
$_['entry_password']  = 'Nova senha:';
$_['entry_confirm']   = 'Repetir a senha:';

// Error
$_['error_email']     = 'Atenção: O endereço de e-mail fornecido não foi encontrado no nosso sistema, por favor tente novamente!';
